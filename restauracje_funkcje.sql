...
exec restauracja_dodajDanie 'gêsina', 18, 3
go
exec restauracja_dodajDanie 'gêsina', 18
go
...
select p.personelID, p.imie, p.nazwisko, p.stanowiskoID, p.pensja, p.restauracjaID from restauracja..personel as p where p.restauracjaID = @id_restauracji
